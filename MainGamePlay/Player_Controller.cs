...
public class Player_Controller : MonoBehaviour
{
    ...
    public void CheckCounter(int _side)
    {
        difficulty.RestCounter(_side);
    }
    ...
    public void SetDieParticles()
    {
        ...
        int particlesAmount = gemsController.GetGemsAmount() / 2;
