...
public class AnunciosAdMob : MonoBehaviour
{
    [Header("Set Up")]
    ...
    string GameID = "ca-app-pub-3365329553832883~7241633997";
    ...
    string rewarded_Ad_ID = "ca-app-pub-3365329553832883/2915871013"; //ELBUENO
    //string rewarded_Ad_ID = "ca-app-pub-3940256099942544/5224354917";  //EL DE PRUEBA
    ...
    public static AnunciosAdMob instance;
    ...
    public void CheckReward()
    {
        ...
        {
            case "gems":
                Victory.Instance.AddButton();
                break;

            case "lifesGamePlay":
                GameOver.Instance.AdButton();
                break;

            case "lifesMain":
                mainSettings.AddButton();
                break;
    ...
    public void SetRewardType(string _type)
    {
        rewardType = _type;
    }
}
